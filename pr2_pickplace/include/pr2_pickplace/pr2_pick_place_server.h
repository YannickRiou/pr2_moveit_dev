...
#include <pr2_pickplace/PickPlace.h>
#include <pr2_pickplace/Grasp.h>
#include <tf/tf.h>
...
public:
  ...
  bool Routine(pr2_pickplace::PickPlace::Request &req,
...
private:
  ...
  const std::string DROPBOX_MESH_PATH =
    "package://pr2_pickplace/models/dropbox/meshes/dropbox.dae";

  std::vector<std::string> OBJECT_MESH_PATH_LIST;
  const std::string OBJECT_1_MESH_PATH =
    "package://pr2_pickplace/models/biscuits/meshes/biscuits.dae";
  const std::string OBJECT_2_MESH_PATH =
    "package://pr2_pickplace/models/soap/meshes/soap.dae";
  const std::string OBJECT_3_MESH_PATH =
    "package://pr2_pickplace/models/soap2/meshes/soap2.dae";
  const std::string OBJECT_MESH_PATH =
    "package://pr2_pickplace/models/";
