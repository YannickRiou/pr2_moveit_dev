...
#include<pr2_pickplace/pr2_pick_place_server.h>
    ...
    left_gripper_group(LEFT_GRIPPER_GROUP)
{
  ...
  grasp_client = nh.serviceClient<pr2_pickplace::Grasp>("/get_grasp");
...
bool PR2PickPlace::Routine(pr2_pickplace::PickPlace::Request &req,
                    pr2_pickplace::PickPlace::Response &res)
{
