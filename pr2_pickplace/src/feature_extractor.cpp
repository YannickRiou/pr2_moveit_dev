...
#include <pr2_pickplace/GetNormals.h>
//#include <pr2_pickplace/GetFloatArrayFeature.h>
...
private:
  ...
  bool getNormalsReq(pr2_pickplace::GetNormals::Request &req, pr2_pickplace::GetNormals::Response &rsp)
  {
...
// bool getVFHReq(pr2_pickplace::GetNormals::Request &req, pr2_pickplace::GetNormals::Response &rsp)
// {
//   pcl::PointCloud<pcl::PointXYZ> *p_cloud = new pcl::PointCloud<pcl::PointXYZ>();
//   const boost::shared_ptr<pcl::PointCloud<pcl::PointXYZ> > sp_pcl_cloud(p_cloud);
//   pcl::fromROSMsg(req.cluster, *p_cloud);
