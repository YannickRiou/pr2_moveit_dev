...
#include<pr2_description/pr2_motion.h>
    ...
    left_gripper_group(LEFT_GRIPPER_GROUP)
{
  ...
  moveit::planning_interface::MoveItErrorCode right_success_code = right_move_group.move();
  bool right_success = right_success_code == moveit_msgs::MoveItErrorCodes::SUCCESS;
  
  moveit::planning_interface::MoveItErrorCode left_success_code = left_move_group.move();
  bool left_success = left_success_code == moveit_msgs::MoveItErrorCodes::SUCCESS;
  ...
  for(size_t i=0; i<pose_list.size();++i)
  {
    ...
    right_success_code = right_move_group.plan(right_arm_plan);
    right_success = right_success_code == moveit_msgs::MoveItErrorCodes::SUCCESS;
  ...
  right_move_group.setNamedTarget("RIGHT_ARM_INITIAL_POSE");
  left_move_group.setNamedTarget("LEFT_ARM_INITIAL_POSE");
  right_success_code = right_move_group.move();
  right_success = right_success_code == moveit_msgs::MoveItErrorCodes::SUCCESS;
  left_success_code = left_move_group.move();
  left_success = left_success_code == moveit_msgs::MoveItErrorCodes::SUCCESS;
}
...
bool PR2Motion::OperateRightGripper(const bool &close_gripper)
{
  ...
  moveit::planning_interface::MoveItErrorCode success_code = right_gripper_group.move();
  bool success = success_code == moveit_msgs::MoveItErrorCodes::SUCCESS;
...
bool PR2Motion::OperateLeftGripper(const bool &close_gripper)
{
  ...
  moveit::planning_interface::MoveItErrorCode success_code = left_gripper_group.move();
  bool success = success_code == moveit_msgs::MoveItErrorCodes::SUCCESS;
  return success;
}
