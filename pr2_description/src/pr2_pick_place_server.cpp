...
#include<pr2_description/pr2_pick_place_server.h>
    ...
    left_gripper_group(LEFT_GRIPPER_GROUP)
{
  ...
  grasp_client = nh.serviceClient<pr2_description::Grasp>("/get_grasp");
...
bool PR2PickPlace::Routine(pr2_description::PickPlace::Request &req,
                    pr2_description::PickPlace::Response &res)
{
  ...
  pr2_description::Grasp grasp_srv;
  ...
  else
  {
    ...
    else
    {
      ...
      left_success_code = left_move_group.plan(left_arm_plan);
      left_success = left_success_code == moveit_msgs::MoveItErrorCodes::SUCCESS;
