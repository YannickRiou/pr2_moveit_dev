...
#include <pr2_description/DetectedObjectsArray.h>
...
private:
  ...
  void cloud_cb(const pr2_description::DetectedObjectsArray& detected_objects);
...
void pick_place_client::cloud_cb (const pr2_description::DetectedObjectsArray& detected_objects)
{
