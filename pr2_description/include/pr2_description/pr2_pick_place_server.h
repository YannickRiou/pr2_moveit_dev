...
#include <pr2_description/PickPlace.h>
#include <pr2_description/Grasp.h>
#include <tf/tf.h>
...
public:
  ...
  bool Routine(pr2_description::PickPlace::Request &req,
...
private:
  ...
  moveit::planning_interface::MoveItErrorCode left_success_code, right_success_code;
  ...
  const std::string DROPBOX_MESH_PATH =
    "package://pr2_description/models/dropbox/meshes/dropbox.dae";

  std::vector<std::string> OBJECT_MESH_PATH_LIST;
  const std::string OBJECT_1_MESH_PATH =
    "package://pr2_description/models/biscuits/meshes/biscuits.dae";
  const std::string OBJECT_2_MESH_PATH =
    "package://pr2_description/models/soap/meshes/soap.dae";
  const std::string OBJECT_3_MESH_PATH =
    "package://pr2_description/models/soap2/meshes/soap2.dae";
  const std::string OBJECT_MESH_PATH =
    "package://pr2_description/models/";
