...
from dcnn_training_pkg.srv import FetchMove, FetchMoveResponse, FetchMoveRequest
import copy
...
def test_rubishbin_disposal():
    ...
    fetch_move_client.move_joints(init_joints_config)
